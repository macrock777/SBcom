...
/**
 * SuppliermasterId entity. @author MyEclipse Persistence Tools
 */
@Embeddable

public class SuppliermasterId implements java.io.Serializable {
	...
	/** default constructor */
	public SuppliermasterId() {
	}

	/** full constructor */
	public SuppliermasterId(Integer uniqueid, String supplierid) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SuppliermasterId))
			return false;
		SuppliermasterId castOther = (SuppliermasterId) other;
