...
public class ReadXlsx {
  ...
  *  as a (basic) CSV.
  */
 private Map<String, ArrayList<String>> sheetData = new LinkedHashMap<String, ArrayList<String>>();
 ...
 private class SheetToCSV implements SheetContentsHandler {
	...
	public void endRow(int arg0) {
		// TODO Auto-generated method stub
		sheetData.put(Integer.toString(currentRow), rowData);
	}
 }
...
///////////////////////////////////////
  ...
  */
 public ReadXlsx(OPCPackage pkg) {
 ...
 public static Map<String, ArrayList<String>> readExcel(String filePath) throws Exception {
     ...
     try (OPCPackage p = OPCPackage.open(xlsxFile.getPath())) {
        ReadXlsx xlsx2csv = new ReadXlsx(p);
        xlsx2csv.process();
